...
namespace MySoft.FTP
{
    ...
    public class FTPclient
    {
        ...
        public bool Upload(FileInfo fi, string targetFilename)
        {
            ...
            return Upload(buffer, targetFilename);
        }
        ...
        /// <param name="targetFilename">Target filename (optional)</param>
        /// <returns></returns>
        public bool Upload(byte[] buffer, string targetFilename)
        {
            ...
            if (targetFilename.Trim() == "")
            {
                ...
                throw new ArgumentNullException("targetFilename Can't for empty!");
            }
