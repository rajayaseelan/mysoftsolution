...
namespace MySoft
{
    ...
    public class DynamicProxy
    {
        ...
        private static readonly Type[] Types_InvocationHandler = new Type[] { typeof(IProxyInvocationHandler) };
        ...
        private static readonly ConstructorInfo DynamicProxy_Ctor = typeof(DynamicProxy).GetConstructor(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance, null, new Type[] { typeof(IProxyInvocationHandler) }, null);
        private static readonly MethodInfo DynamicProxy_Invoke = typeof(IProxyInvocationHandler).GetMethod("Invoke", new Type[] { typeof(Object), typeof(MethodInfo), typeof(Object[]) });
        ...
        public static IProxyInvocationHandler GetInvocationHandler(Object proxy)
        {
            if (proxy == null)
            {
                throw new ArgumentNullException();
