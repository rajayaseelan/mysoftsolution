...
{
    /// <summary>
    /// This is our base class. It tries to mimick the behaviour of a standard MessageListBox. It's
    ...
    public class ResizableListBox : System.Windows.Forms.Panel
    {
        ...
        /// like in the original MessageListBox.
        /// </summary>
        /// <param name="pe"></param>
        ...
        public int SelectedIndex
        {
            ...
            set
            {
                ...
                if (value >= 0)
                {
                    this.AutoScrollPosition = new Point(0, 30 * value);
                }
            }
        }
