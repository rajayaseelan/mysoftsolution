...
namespace MySoft.Web.Configuration
{
    ...
    /// </summary>
    [Serializable]
    public class RewriterConfigurationHandler : IConfigurationSectionHandler
    {
        /// <summary>
        ...
        public object Create(object parent, object configContext, System.Xml.XmlNode section)
        {
            ...
            XmlSerializer ser = SerializationManager.GetSerializer(typeof(RewriterConfiguration));
