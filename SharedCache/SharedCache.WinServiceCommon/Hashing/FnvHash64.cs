...
// Modified:  16-02-2008 SharedCache.com, rschuetz : more information about this hashing algorithm: http://www.codeplex.com/EnyimMemcached
...
namespace SharedCache.WinServiceCommon.Hashing
{
	...
	/// </summary>
	public class FnvHash64 : HashAlgorithm
	{
		/// <summary>
		/// represent a initial value
		/// </summary>
		private const ulong FnvInitializeValue = 0xcbf29ce484222325L;
		/// <summary>
		/// prinzipal value
		/// </summary>
		private const ulong FnvPrincipalValue = 0x100000001b3L;
		/// <summary>
