...
using SharedCache.WinServiceCommon.SharpZipLib.Encryption;
using SharedCache.WinServiceCommon.SharpZipLib.Checksum;
using SharedCache.WinServiceCommon.SharpZipLib.Zip.Compression;
