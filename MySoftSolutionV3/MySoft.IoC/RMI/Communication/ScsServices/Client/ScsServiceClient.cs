...
using MySoft.Communication.ScsServices.Communication;
using MySoft.Communication.ScsServices.Communication.Messages;

namespace MySoft.Communication.ScsServices.Client
{
    /// <summary>
